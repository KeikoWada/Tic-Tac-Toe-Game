...
var onTrackSuccess = function onTrackSuccess(data) {
...
var onTrackSuccessTwo = function onTrackSuccessTwo(data) {
  data.game = store.game;
...
module.exports = {
  ...
  onTrackSuccessTwo: onTrackSuccessTwo,
  // onTrackFailure,
...
var signUp = function signUp(data) {
  return $.ajax({
    ...
    data: data // :data has to be the same as perimiter in this function
  });
};
...
var onCreateNewGame = function onCreateNewGame(event) {
  ...
  api.create(data).then(ui.onCreateNewSuccess);
};
...
var onTrack = function onTrack(event) {
  event.preventDefault();
  api.tracker(event).then(ui.onTrackSuccess);
};

var onTrackTwo = function onTrackTwo(event) {
  event.preventDefault();
  api.tracker(event).then(ui.onTrackSuccessTwo);
};
module.exports = {
